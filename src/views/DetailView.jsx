      ...
      <div className="detail-content container">
        ...
        <div className="detail-grid">
          ...
          <div className="right-column">
            {/* Descripción */}
            <Card className="detail-section-card glass-card" padding="m">
              ...
              <div className="physical-row">
                <div className="phys-item">
                  ...
                  <span className="phys-value">{(pokemon.height / 10).toFixed(1)} m</span>
                </div>
                <div className="phys-item">
                  <span className="phys-label">Peso</span>
                  <span className="phys-value">{(pokemon.weight / 10).toFixed(1)} kg</span>
                </div>
                <div className="phys-item">
                  <span className="phys-label">Ratio Captura</span>
                  <span className="phys-value">{((pokemon.capture_rate / 255) * 100).toFixed(0)}%</span>
                </div>
              </div>
            </Card>
                  ...
                  {pokemon.stats.map((s) => {
                    ...
                    return (
                      <div key={s.stat.name} className="stat-progress-row">
                        <span className="stat-progress-label">{STAT_LABELS[s.stat.name] || s.stat.name}</span>
                        ...
                        <div className="stat-bar-outer">
                          <motion.div 
                            ...
                            style={{
                              background: pct > 60 ? '#4CAF50' : pct > 35 ? '#FFC107' : '#FF5252'
                            }}
                          />
                        </div>
                      </div>
